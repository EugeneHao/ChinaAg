...
$$
z_{ijt} = \beta_{i0} + \sum_{k=1}^4 E\pi_{kjt}\beta_{ik}+ u_{j} + \epsilon_{ijt}
$$
where 
...
$$
z_{ijt} = \beta_{i0} + \sum_{k=1}^4 Er_{kjt}\beta_{ik}+ u_{j} + \epsilon_{ijt}
$$
...
$$
z_{ijt} = \beta_{i0} + \sum_{k=1}^3 Err_{kjt}\beta_{ik}+ u_{j} + \epsilon_{ijt}
$$
Some figures: 
...
#summary(lm_soy_pf)
#summary(lm_wheat_pf)
stargazer(lm_corn_pf, lm_rice_pf, lm_soy_pf, lm_wheat_pf, title = "Model 1 Results",column.labels = c("Corn", "Rice", "Soybean", "Wheat"), type = "text", digit = 3, dep.var.caption  = "")
```
...
stargazer(lm_corn_rev, lm_rice_rev, lm_soy_rev, lm_wheat_rev, title = "Model 2 Results",column.labels = c("Corn", "Rice", "Soybean", "Wheat"), type = "text", digit = 3, dep.var.caption  = "")
...
stargazer(lm_corn_rr, lm_rice_rr, lm_soy_rr, lm_wheat_rr, title = "Model 3 Results",column.labels = c("Corn", "Rice", "Soybean", "Wheat"), type = "text", digit = 3, dep.var.caption  = "")
