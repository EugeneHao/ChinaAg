...
regdat <- readRDS("../From Hao/data/dongbei/regdat_V2.rds") %>% 
...
preddat <- readRDS("../From Hao/data/dongbei/preddat_V2.rds") %>% 
...
```{r}
randshare_newsame <- readRDS("../From Hao/report/0506/randshare_newsame.rds")

randshare_new01 <- readRDS("../From Hao/report/0506/randshare_new01.rds")
randshare_new02 <- readRDS("../From Hao/report/0506/randshare_new02.rds")
randshare_new03 <- readRDS("../From Hao/report/0506/randshare_new03.rds")
...
```{r}
rawacre <- readxl::read_xls("../From Hao/rawdata/PlantAcre0409.xls")
